...
rDownloadURL = {"main": "https://media.githubusercontent.com/media/edik1963/xtream-ui-ubuntu-24.04/main/main_xui.zip", "sub": "https://media.githubusercontent.com/media/edik1963/xtream-ui-ubuntu-24.04/main/sub_xui.zip"}
import os
...
def configure():
    ...
    if not os.path.exists("/home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb"): os.system("wget -q https://raw.githubusercontent.com/edik1963/xtream-ui-ubuntu-24.04/refs/heads/main/GeoLite2.mmdb -O /home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb")
    if not os.path.exists("/home/xtreamcodes/iptv_xtream_codes/crons/pid_monitor.php"): os.system("wget -q https://raw.githubusercontent.com/edik1963/xtream-ui-ubuntu-24.04/refs/heads/main/pid_monitor.php -O /home/xtreamcodes/iptv_xtream_codes/crons/pid_monitor.php")
...
if __name__ == "__main__":
    ...
    if not rVersion in rVersions:
        ...
        sys.exit(1)
    printc("X-UI installer in Ubuntu %s - Edik-1963" % rVersion, col.GREEN, 2)
    print(" ")
